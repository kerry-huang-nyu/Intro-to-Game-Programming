...
public:
    ...
    void update(float delta_time, Entity* player, std::vector<Entity*>& others, Map* map, std::ofstream&);
    ...
    void       const check_collision_entity_y(Entity*, std::ostream& log);
    void       const check_collision_entity_x(Entity*, std::ostream& log);
